     ...
     <script type="text/javascript">
        $(document).ready(function(){
            ...
            $("#addItem").click(function(){
                ...
                $(".forappend").after('<tr  style="width:100%;"><td style="width: 25%;"><input  style="width: 150%;" type="text" name="cat[]" id="cat" value="" ><input  style="width: 150%;" type="hidden" name="catrecno[]" id="catrecno" value="" ></td><td style="width: 15%;"><input style="width: 100%;" type="text" name="Moneyflow[]" id="Moneyflow" value="" ></td><td style="width: 45%;"><input  style="width: 120%;" type="text" name="Narration[]" id="Narration" value="" ></td><td style="width: 15%;"><button style="margin-right: 30px;" type="button" title="delete" id="catrecno" onclick="rowremove(this)">*</button><button type="button" title="edit" id="edit" onclick="rowedit(this)">-</button></td></tr>');
        ...
        <div class="user-details">
         ...
         <div class="user-details">
            ...
            <table>
                ...
                <tr>
                    <td style="width: 25%;">
                        <input  style="width: 150%;" type="hidden" name="hdnCategory" id="hdnCategory" value="" >
